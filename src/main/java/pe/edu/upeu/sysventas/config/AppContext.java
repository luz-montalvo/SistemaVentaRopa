...
import pe.edu.upeu.sysventas.service.impl.PrendaServiceImp;
...
public class AppContext {
    ...
    private void registrarRepositorios() {
        ...
        registrar(PrendaRepository.class, new PrendaRepository());
    ...
    private void registrarServicios() {
        ...
        registrar(IPrendaService.class,
                new PrendaServiceImp( getBean(PrendaRepository.class)));
    ...
    private void registrarControladores() {
        ...
        registrar(PrendaController.class,
                new PrendaController(
                        getBean(IPrendaService.class)));
